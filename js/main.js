$(document).ready(function(){
  $('.fruit li').click(function(){
    ...
    } else if (fruit === 'pinnaple') {
      $('#title').html('Pineapple');
      $('#description').html('Pineapples can be consumed fresh, cooked, juiced, or preserved. They are found in a wide array of cuisines. In addition to consumption, the pineapple leaves are used to produce the textile fiber piña in the Philippines, commonly used as the material for the mens leaves barong Tagalog and womens barot saya formal wear in the country. The fiber is also used as a component for wallpaper and other furnishings.');
...
//who and what who:apple what:click event
