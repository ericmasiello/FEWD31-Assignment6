$(document).ready(function(){
	...
	$('li.apple').click(function(){
		...
		descriptionAdd('apple');
	});

	$('li.banana').click(function(){
		cleanupWork();
		fruiTitle === 'banana';
		$(this).addClass('active');
		descriptionAdd('banana');
	});

	$('li.cherry').click(function(){
		cleanupWork();
		fruiTitle === 'cherry';
		$(this).addClass('active');
		descriptionAdd('cherry');
	});

	$('li.grape').click(function(){
		cleanupWork();
		fruiTitle === 'grape';
		$(this).addClass('active');
		descriptionAdd('grape');
	});
	...
	$('li.orange').click(function(){
		...
		fruiTitle === 'orange';
		$(this).addClass('active');
		descriptionAdd('orange');
	});

	$('li.peach').click(function(){
		cleanupWork();
		fruiTitle === 'peach';
		$(this).addClass('active');
		descriptionAdd('peach');
	});

	$('li.pear').click(function(){
		cleanupWork();
		fruiTitle === 'pear';
		$(this).addClass('active');
		descriptionAdd('pear');
	...
	$('li.pineapple').click(function(){
		cleanupWork();
		fruiTitle === 'pineapple';
		$(this).addClass('active');
		descriptionAdd('pineapple');
	});

	$('li.strawberry').click(function(){
		cleanupWork();
		fruiTitle === 'strawberry';
		$(this).addClass('active');
		descriptionAdd('strawberry');
	});
...
function descriptionAdd(fruiTitle){
	if (fruiTitle==='apple') {
		$('#title').html('Apple');
