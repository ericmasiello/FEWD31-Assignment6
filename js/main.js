$(document).ready(function() {
  ...
  function showFruit(event) {
    ...
    var fruitName=$(this).attr('class');

    if (fruitName === 'apple active') {
      $('#title').html('Apple');
    ...
    else if (fruitName === 'banana active') {
      $('#title').html('Banana');
    ...
    else if (fruitName === 'cherry active') {
      $('#title').html('Cherry');
    ...
    else if (fruitName === 'grape active') {
      $('#title').html('Grape');
    ...
    else if (fruitName === 'orange active') {
      $('#title').html('Orange');
    ...
    else if (fruitName === 'peach active') {
      $('#title').html('Peach');
    ...
    else if (fruitName === 'pineapple active') {
    ...
    else if (fruitName === 'strawberry active') {
